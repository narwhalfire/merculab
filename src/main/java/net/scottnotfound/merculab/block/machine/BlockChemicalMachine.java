...
public class BlockChemicalMachine extends BlockChemicalBase {
    ...
    public BlockChemicalMachine(String name) {
        super(Material.ROCK);
        this.name = name;
    }
    ...
    public void init() {
        ...
        ItemBlock itemBlock = new ItemBlockChemicalMachine(this);
    ...
    private Class<? extends TileEntity> getTileEntityClass() {
        ...
        try {
            tileEntityClass = Class.forName("net.scottnotfound.merculab.block.machine.TileEntity"
