package net.scottnotfound.merculab.block.storage;
...
public class BlockChemicalContainer extends BlockChemicalBase {
    ...
    public BlockChemicalContainer(String name) {
        super(Material.IRON);
        this.name = name;
    }
    ...
    public void init() {
        ...
        ItemBlock itemBlock = new ItemBlockChemicalContainer(this);
    ...
    private Class<? extends TileEntity> getTileEntityClass() {
        ...
        try {
            tileEntityClass = Class.forName("net.scottnotfound.merculab.block.storage.TileEntity"
